                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select @error('currency') is-invalid @enderror" id="currency" name="currency" style="max-width: 120px;" required>
                                <option value="RWF" {{ old('currency', $subscription->currency ?? 'RWF') == 'RWF' ? 'selected' : '' }}>RWF</option>
                                <option value="USD" {{ old('currency', $subscription->currency ?? 'RWF') == 'USD' ? 'selected' : '' }}>USD</option>
                                <option value="EUR" {{ old('currency', $subscription->currency ?? 'RWF') == 'EUR' ? 'selected' : '' }}>EUR</option>
                                <option value="GBP" {{ old('currency', $subscription->currency ?? 'RWF') == 'GBP' ? 'selected' : '' }}>GBP</option>
                            </select>
                        </div>
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
