...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- Preload key SVG screenshots to avoid flicker and catch server issues early -->
    <link rel="preload" as="image" href="{{ asset('images/screenshots/dashboard.svg') }}">
    <link rel="preload" as="image" href="{{ asset('images/screenshots/members.svg') }}">
    <link rel="preload" as="image" href="{{ asset('images/screenshots/classes.svg') }}">
    <link rel="preload" as="image" href="{{ asset('images/screenshots/payments.svg') }}">
    ...
    <style>
        ...
        /* Fix for clickable links - override Tailwind reset */
        a {
        ...
        /* Ensure all buttons and forms are clickable */
        button, .btn, form {
            cursor: pointer !important;
            pointer-events: auto !important;
        }
        ...
        #screenshotsCarousel .carousel-caption {
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#classes">Locations</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="py-5 bg-white" id="screenshots">
            <div class="container">
                <h2 class="text-center mb-3">See It In Action</h2>
                <p class="text-center text-muted mb-5">Explore our powerful features through real application screenshots</p>
                
                <div id="screenshotsCarousel" class="carousel slide" data-bs-ride="carousel">
                    <!-- Indicators -->
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#screenshotsCarousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Dashboard"></button>
                        <button type="button" data-bs-target="#screenshotsCarousel" data-bs-slide-to="1" aria-label="Members"></button>
                        <button type="button" data-bs-target="#screenshotsCarousel" data-bs-slide-to="2" aria-label="Classes"></button>
                        <button type="button" data-bs-target="#screenshotsCarousel" data-bs-slide-to="3" aria-label="Payments"></button>
                    </div>

                    <!-- Slides -->
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('images/screenshots/dashboard.svg') }}" class="d-block w-100" alt="Dashboard Overview" style="border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                            <div class="carousel-caption d-none d-md-block" style="background: rgba(0,0,0,0.7); border-radius: 10px; padding: 1rem;">
                                ...
                                <p>Track all your gym metrics at a glance with real-time analytics and insights.</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/screenshots/members.svg') }}" class="d-block w-100" alt="Member Management" style="border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                            <div class="carousel-caption d-none d-md-block" style="background: rgba(0,0,0,0.7); border-radius: 10px; padding: 1rem;">
                                <h5>Member Management</h5>
                                <p>Easily manage member profiles, subscriptions, and track attendance across all locations.</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/screenshots/classes.svg') }}" class="d-block w-100" alt="Class Schedule" style="border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                            <div class="carousel-caption d-none d-md-block" style="background: rgba(0,0,0,0.7); border-radius: 10px; padding: 1rem;">
                                <h5>Class Scheduling</h5>
                                <p>Schedule and manage classes with visual calendar view and automated notifications.</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/screenshots/payments.svg') }}" class="d-block w-100" alt="Payment Management" style="border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                            <div class="carousel-caption d-none d-md-block" style="background: rgba(0,0,0,0.7); border-radius: 10px; padding: 1rem;">
                                <h5>Payment & Billing</h5>
                                <p>Process payments, track revenue, and manage billing with detailed financial reports.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-5 bg-light" id="features">
            <div class="container">
                <h2 class="text-center mb-5">Multi-Gym Management Features</h2>
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card h-100 feature-card">
                            <div class="card-body text-center">
                                ...
                                <p>Seamlessly manage multiple gym locations from a single dashboard with location-specific data.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 feature-card">
                            <div class="card-body text-center">
                                ...
                                <p>Track memberships, attendance, and payments across all your gym locations effortlessly.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 feature-card">
                            <div class="card-body text-center">
                                ...
                                <p>Schedule and manage classes for each location with automated attendance tracking.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 feature-card">
                            <div class="card-body text-center">
                                ...
                                <p>Handle subscriptions and payments with detailed tracking per location and member.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 feature-card">
                            <div class="card-body text-center">
                                ...
                                <p>Get insights on revenue, attendance, and membership trends for each location.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 feature-card">
                            <div class="card-body text-center">
                                ...
                                <p>Admin, Manager, Receptionist, Trainer, and Member roles with appropriate permissions.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-5 bg-light" id="classes">`
            <div class="container">
                ...
                <div class="row g-4">
                        @forelse(\App\Models\Gym::take(6)->get() as $gym)
                    <div class="col-md-4">
                        <div class="card h-100 feature-card">
                            <div class="card-body">
                                <h5 class="card-title"><i class="bi bi-building me-2"></i>{{ $gym->name }}</h5>
                                <p class="card-text">
                                    <i class="bi bi-geo-alt me-2"></i>
                                    {{ $gym->address ?? 'Address TBD' }}
                                </p>
                                <p class="card-text">
                                    <i class="bi bi-telephone me-2"></i>
                                    {{ $gym->phone ?? 'Contact: TBD' }}
                                </p>
                                <p class="card-text">
                                    <i class="bi bi-people-fill me-2"></i>
                                    {{ $gym->members()->count() }} Members
                                </p>
                            </div>
                        </div>
                    </div>
                    @empty
                    <div class="col-12 text-center">
                        <p class="text-muted">Gym locations will be displayed here once configured.</p>
                    </div>
                    @endforelse
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="testimonial-card">
                            ...
                            <h5>Sarah Johnson</h5>
                            <p class="text-muted">Gym Chain Owner</p>
                            <p>"This platform revolutionized how we manage our 5 gym locations. Everything is seamlessly integrated!"</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="testimonial-card">
                            ...
                            <h5>Michael Chen</h5>
                            <p class="text-muted">Fitness Manager</p>
                            <p>"The reporting and analytics help us make data-driven decisions across all our locations."</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="testimonial-card">
                            <img src="https://randomuser.me/api/portraits/women/2.jpg" alt="Client" class="testimonial-img">
                            <h5>Emma Davis</h5>
                            <p class="text-muted">Operations Director</p>
                            <p>"Managing members, classes, and payments has never been easier. Highly recommended!"</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h5 class="d-flex align-items-center">
                            <img src="{{ asset('images/logo.svg') }}" alt="GMS Logo" style="height: 30px; margin-right: 10px;">
                            {{ config('app.name', 'GymMate') }}
                        </h5>
                        <p>Comprehensive multi-location gym management platform for fitness businesses of all sizes.</p>
                    </div>
                    <div class="col-md-4">
                        <h5>Quick Links</h5>
                        <ul class="list-unstyled">
                            <li><a href="#features" class="text-light text-decoration-none">Features</a></li>
                            <li><a href="#classes" class="text-light text-decoration-none">Classes</a></li>
                    ...
                    <div class="col-md-4">
                        <h5>Contact Us</h5>
                        <ul class="list-unstyled">
                            <li><i class="bi bi-geo-alt me-2"></i>Kigali, City</li>
                            <li><i class="bi bi-telephone me-2"></i>(250) 7861-63963</li>
                            <li><i class="bi bi-envelope me-2"></i>info@gymmate.rw</li>
                        </ul>
                    </div>
                </div>
                <hr>
                <div class="text-center">
                    <p class="mb-0">&copy; {{ date('Y') }} {{ config('app.name', 'GymMate') }}. Powering multi-location fitness management.</p>
                </div>
            </div>
        </footer>
